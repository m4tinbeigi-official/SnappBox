...
class ShippingMethod extends \WC_Shipping_Method
{
    ...
    public function boot(): void {
        \add_filter('woocommerce_shipping_methods', [$this, 'snappb_add_method']);
    }
    ...
    public function snappb_init()
    {
        ...
        \add_action('admin_enqueue_scripts', [$this, 'snappb_enqueue_leaflet_scripts'], 10, 1);
        ...
        if ($chosen_shipping_method === 'snappbox_shipping_method') {
            ...
            if (!empty($polygon_json)) {
                ...
                $is_inside = $this->snappb_point_in_polygon(
                    [(float)$customerLong, (float)$customerLat],
                    $polygon
                );
    ...
    protected function enqueue_maplibre_assets() { /* Same as before, using SNAPPBOX_URL */ }
    protected function enqueue_maplibre_inline_script($lat, $lng) { /* Same as before */ }
    public function snappb_zone_alert_modal() { /* Same */ }
    public function calculate_shipping($package = []) { /* Same */ }
}
