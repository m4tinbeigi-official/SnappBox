...
class OrderAdmin {
	...
	public function boot(): void {
		...
		\add_action( 'woocommerce_admin_order_data_after_order_details', array( $this, 'display_order_admin_box' ), 20, 1 );
		\add_action( 'wp_ajax_snappb_create_order', array( $this, 'handle_create_order' ) );
		\add_action( 'wp_ajax_snappb_cancel_order', array( $this, 'handle_cancel_order' ) );
